            ...
            <div class="col-md-12">
                ...
                <form action="create_account_final.php" method="POST">
                    <div class="shadow px-3 py-3">
                        ...
                        <div class="card-header justify-content-end text-end">
                            <input type="text" class="form-control w-25" name="cust_ref_number" value="<?php echo get_random_figures($firstname . $lastname . $midname);?>">
                        </div>
                        ...
                        <div class="card-body">
                            <div class="container-fluid">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-6">
                                        <p class="lead bg-white shadow px-2 py-2">Gender
                    ...
                    <div class="card-footer">
                        <div class="d-flex flex-row-reverse">
                            <button class="btn-lg btn btn-outline-danger" name="create_account_complete"> Complete <bi class="bi-caret-right"></bi></button>
                        </div>
                    </div>
                </form>
            </div>
